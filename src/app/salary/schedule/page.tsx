...
export default function SchedulePage() {
    ...
    const hourlyWage =
        salarySettings?.payType === "hourly"
            ? Number(salarySettings.hourlyWage ?? 0)
            : 0;
        ...
        const loadHolidays = async () => {
            try {
                const response = await fetch(
                    `/api/holidays?year=${year}&province=${salarySettings.province}`,
                );
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {isPayDate && (
                                            <span className="absolute bottom-0 text-[8px] font-medium text-gray-500">
                                                급여일
                                            </span>
                                        )}
                                    </button>
                    ...
                    <>
                        ...
                        {currentMonthSchedules.length >
                            ...
                            >
                                {showAllSchedules
                                    ? "접기"
                                    : `전체 ${currentMonthSchedules.length}개 보기`}
                            </button>
                        )}
                    </>
                )}
